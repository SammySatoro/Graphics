...
def lab5():
    ...
    ambient = (0, 0, 0, 1)
    lightpos = (0, 3, 0) # light source position
    coef = 0
    ...
    while run:
        ...
        glEnable(GL_LIGHT0)
        glLightfv(GL_LIGHT0, GL_AMBIENT, [0.0, 1.0, 0.0, 0.1])  # sphere color
        glLightfv(GL_LIGHT0, GL_DIFFUSE, [0.0, 1.0, 0.0, 0.3])  # light color
